        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
          <div className="p-3 rounded-md bg-white text-center">
            ...
            <a
              ...
              className="text-[#64748B] hover:text-gray-600 transition-colors text-[14px]"
            >
              slgroup@slshop.ru
            </a>
          </div>
          ...
          <div className="p-3 rounded-md bg-white text-center">
            ...
            <a
              ...
              className="text-blue-600 underline hover:text-blue-700 transition-colors text-[14px]"
              target="_blank"
